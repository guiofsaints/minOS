...
void save_settings()
{
    ...
    // TrimUI Brick LED support hardcoded
    int is_brick = 1; // Always TrimUI Brick
    int maxlights = 4;
...
int main(int argc, char *argv[])
{
    ...
    while (!quit)
    {
        ...
        if (dirty)
        {
            ...
            // Display settings
            // TrimUI Brick labels hardcoded
            const char *settings_labels[5] = {"Effect", "Color", "Speed", "Brightness", "Info brightness"};
